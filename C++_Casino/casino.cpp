...
void showLoadingScreen() {
    SetColor(14);
    clearScreen();
    system("Casino"); // 콘솔창 이름 설정
    system("mode con:cols=61 lines=15"); // 콘솔창 크기설정
    SetConsoleFontSize(18); //폰트 크기 18
    cout << "\n\n" << endl;
    cout << "============================================================\n";
    cout << "||                                                        ||\n";
    cout << "||                     C A S I N O                        ||\n";
...
int displayMainMenu() {
    int choice;
    system("Menu"); // 콘솔창 이름 설정
    system("mode con:cols=53 lines=15"); // 콘솔창 크기설정
    SetConsoleFontSize(18); //폰트 크기 18
    cout << "" << endl;
...
void PlaySnailRace() {
    ...
    SetColor(15);
    system("mode con:cols=75 lines=15"); // 콘솔창 크기설정
...
void PlayBlackjack() {
    system("cls");
    cout << "블랙잭 게임을 시작합니다...\n";
    system("mode con:cols=53 lines=35"); // 콘솔창 크기설정
    SetColor(15);
